 ...
 */
public class RTToolbarImageButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    public RTToolbarImageButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.rte_ToolbarButton, defStyle, 0);
        mChecked = a.getBoolean(R.styleable.rte_ToolbarButton_checked, false);
        a.recycle();
    }
