...
public class ColorView extends LinearLayout {
    ...
    private static final int CHECKMARK_CHECK_VIEW_PERCENT = 1;
    ...
    public void setCheckMarkerDrawable(int resId) {
        if (this.mCheckView instanceof ColorCheckedViewCheckmark) {
            ((ColorCheckedViewCheckmark) this.mCheckView).setImageResource(resId);
        }
    }
}
